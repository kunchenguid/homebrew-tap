cask "hi-bit" do
  version "0.0.11"
  sha256 "1aa60df8bc8b1eaaa8aeccc60137a9607b6584ef3251b87c867a6054662962c6"

  url "https://github.com/kunchenguid/hi-bit/releases/download/hi-bit-v0.0.11/Hi-Bit-0.0.11-universal.dmg"
  name "Hi-Bit"
