cask "hi-bit" do
  version "0.0.4"
  sha256 "8affc8335088fa7a1baccf96ff67c0204629ff37efa83c4176383c337a0ddd73"

  url "https://github.com/kunchenguid/hi-bit/releases/download/hi-bit-v0.0.4/Hi-Bit-0.0.4-universal.dmg"
  name "Hi-Bit"
